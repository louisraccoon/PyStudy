...
"}")
        ...
        self.editorBox.setMaximumSize(QtCore.QSize(450, 16777215))
        ...
        self.horizontalLayout_4.addWidget(self.editorBox)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.previewerBox = QtWidgets.QGroupBox(self.centralwidget)
        ...
        self.verticalLayout.addWidget(self.previewerBox)
        self.previewerBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout.addWidget(self.previewerBox_2)
